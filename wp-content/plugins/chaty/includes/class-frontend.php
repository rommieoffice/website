    ...
    function cht_front_end_css_and_js()
    {
        if ($this->canInsertWidget()) :
            ...
            if ($len >= 1 && !empty($data['chaty_widgets'])) {
                ...
                // WP change this
                wp_enqueue_style('chaty-front-css', CHT_PLUGIN_URL."css/chaty-front.css", [], CHT_VERSION.$chaty_updated_on);
                // wp_add_inline_style('chaty-front-css', $chaty_css);
                wp_enqueue_script("chaty-front-end", CHT_PLUGIN_URL."js/cht-front-script.js", [ 'jquery' ], CHT_VERSION.$chaty_updated_on, true);
